...
public class Dane
{
    ...
    public static final String HLA_NOWA_KASA = "HLAinteractionRoot.NowaKasa";
    ...
    public static final String HLA_START_SYMULACJI = "HLAinteractionRoot.StartSymulacji";
    public static final String HLA_STOP_SYMULACJI = "HLAinteractionRoot.StopSymulacji";
    ...
    public static final int LICZBA_POCZATKOWYCH_KAS = 3;
    public static final int LICZBA_POCZATKOWYCH_KLIENTOW = 10;
    public static final int LICZBA_POCZATKOWYCH_VIP = 5;
